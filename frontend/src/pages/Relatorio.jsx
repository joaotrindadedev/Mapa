  ...
  return (
    <div className="p-7.5">
      ...
      <p className="text-[#6A6A6A] text-[14px]">
        Consulte o tempo de permanência da equipe em cada local.{" "}
      </p>

      <div className="flex my-6.25 items-end justify-between">
        <div className="flex gap-2 items-end">
          <Input type={"date"} label={"Data"} />
          <button className="w-20 h-9 bg-[#235BC6] text-white text-[16px] rounded-[5px] cursor-pointer transition active:opacity-80">
            Filtrar
          </button>
        </div>

        <button className="w-50 h-9 bg-[#235BC6] text-white text-[16px] rounded-[5px] cursor-pointer transition active:opacity-80">
          Exportar CSV
        </button>
      </div>
